...
| `bin/ambrosio` | The CLI: `start` (the fleet view and the watcher together), `morning`, `status`, `dispatch`, `queue`, `answer`, `digest`, `inbox`, `tick`, `setup`. |
...
bin/ambrosio morning   # the brief: carryover, PRs, Linear, what is ready
bun test               # 180 tests
```
